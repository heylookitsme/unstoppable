class UsersController < ApplicationController
  ...
  before_action :authenticate_user!, :except => [:confirm_email, :confirm_email_json, :terms, :appjson_newuser, :update_password_json, :email_confirmation, :remind_confirmation]
  #layout "sidebar"
